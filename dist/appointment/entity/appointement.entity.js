...
exports.AppointmentEntity = exports.AppointmentStatus = exports.AppointmentType = void 0;
...
__decorate([
    (0, typeorm_1.Column)({ name: 'slot', type: 'timestamp' }),
...
__decorate([
    (0, typeorm_1.ManyToOne)(() => branch_entity_1.BranchEntity, (branchEntity) => branchEntity.asserts),
