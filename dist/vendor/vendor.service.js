...
let VendorService = class VendorService {
    ...
    async updateVendorDetails(dto, filePath) {
        try {
    ...
    async createVendorDetails(dto, filePath) {
        try {
    ...
    async handleVendorDetails(dto, photo) {
        try {
            ...
            throw new error_response_1.ErrorResponse(5416, `Failed to handle vendor details: ${error.message}`);
        }
    }
