...
export class WebsiteProductController {
  ...
  async handleWebsiteProductDetails(
    ...
    try {
      ...
      console.error("Error saving WebsiteProduct details:", error);
      return new CommonResponse(
        false,
        500,
        "Error saving WebsiteProduct details"
      );
    }
  }
  ...
  async getWebsiteProductDetails(
    @Body() req: CommonReq
  ): Promise<CommonResponse> {
    try {
      ...
      return new CommonResponse(
        false,
        500,
        "Error fetching WebsiteProduct details"
      );
    }
  }
  ...
  async getWebsiteProductDetailsById(
    ...
    try {
      ...
      return new CommonResponse(
        false,
        500,
        "Error fetching WebsiteProduct by ID"
      );
    }
  }
